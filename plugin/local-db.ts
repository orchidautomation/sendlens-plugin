...
export const CURRENT_SCHEMA_MIGRATION_ID = "202608080001_sender_domain_lineage";
...
async function ensureSchema(conn: DuckDBConnection) {
  ...
  const statements = [
    ...
    `CREATE TABLE IF NOT EXISTS sendlens.campaign_analytics (
      ...
      reply_count_automatic_unique INTEGER,
      link_click_count INTEGER,
      link_click_count_unique INTEGER,
      open_count_unique_by_step VARCHAR,
      reply_count_unique_by_step VARCHAR,
      reply_count_automatic_unique_by_step VARCHAR,
      link_click_count_unique_by_step VARCHAR,
    ...
    "ALTER TABLE sendlens.campaign_analytics ADD COLUMN IF NOT EXISTS reply_count_automatic_unique INTEGER",
    "ALTER TABLE sendlens.campaign_analytics ADD COLUMN IF NOT EXISTS link_click_count_unique INTEGER",
    "ALTER TABLE sendlens.campaign_analytics ADD COLUMN IF NOT EXISTS open_count_unique_by_step VARCHAR",
    "ALTER TABLE sendlens.campaign_analytics ADD COLUMN IF NOT EXISTS reply_count_unique_by_step VARCHAR",
    "ALTER TABLE sendlens.campaign_analytics ADD COLUMN IF NOT EXISTS reply_count_automatic_unique_by_step VARCHAR",
    "ALTER TABLE sendlens.campaign_analytics ADD COLUMN IF NOT EXISTS link_click_count_unique_by_step VARCHAR",
    ...
    "ALTER TABLE sendlens.step_analytics ADD COLUMN IF NOT EXISTS unique_opens INTEGER",
    "ALTER TABLE sendlens.step_analytics ADD COLUMN IF NOT EXISTS unique_replies_automatic INTEGER",
    "ALTER TABLE sendlens.step_analytics ADD COLUMN IF NOT EXISTS unique_clicks INTEGER",
    "ALTER TABLE sendlens.step_analytics ADD COLUMN IF NOT EXISTS unique_opportunities INTEGER",
    "ALTER TABLE sendlens.step_analytics ADD COLUMN IF NOT EXISTS meetings_booked INTEGER",
