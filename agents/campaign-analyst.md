...
- <aggregate unique human replies vs selected-status hydrated bodies; statuses/OOO; fetch_latest_of_thread and stored context basis; per-status counts; exhaustion; numeric gap; neutral explanation>
