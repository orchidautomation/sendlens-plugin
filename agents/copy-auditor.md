...
If personalization depends on campaign variables, inspect those variable values through `custom_payload` for that one campaign instead of assuming shared payload columns.
