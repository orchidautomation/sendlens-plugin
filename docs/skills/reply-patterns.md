...
8. After hydration, report aggregate unique human replies separately from selected List Email body coverage: statuses, OOO exclusion, `latest_of_thread`, per-status fetched/hydrated counts, exhaustion, and the explicit numeric gap.
