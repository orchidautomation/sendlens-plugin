...
- If hydrated replies describe a different product, compliance domain, industry, or value proposition than `campaign_variants` or reconstructed outbound suggest, treat it as a possible wrong-template or wrong-topic delivery issue before judging copy quality.
...
- Do not treat replies generated by mismatch complaints as proof that the intended copy angle was tested.
